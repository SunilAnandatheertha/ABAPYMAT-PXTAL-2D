...
Modelinfo08B = (('N_Grains_Y_loc_1 @B1T.. all > 0', '2'),
                ...
                ('N_Grains_Y_loc_8 @B8T', '2'),
                ('dummy', ':::'),
                ('N_Grains_Y_loc_8 @B8B', '2'),
...
Modelinfo09B = (('TopEdge.SeedSize.AllGrains_in_Loc: @B1T.. all > 0', '0.03'),
                ...
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B4T', '0.12'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B5T', '0.25'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B6T', '0.50'),
                ...
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B6B', '0.50'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B5B', '0.25'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B4B', '0.12'),
...
if Sample_Location[0] in ['B', 'b', 'LocB', 'Loc_B', 'locb', 'loc_b']:
    TESS_NGY01, TESS_NGY02, TESS_NGY03, TESS_NGY04, TESS_NGY05, TESS_NGY06, TESS_NGY07, TESS_NGY08, dummy,\
    BESS_NGY09, BESS_NGY10, BESS_NGY11, BESS_NGY12, BESS_NGY13, BESS_NGY14, BESS_NGY15, BESS_NGY16\
    ...
    SD_allG_BESS_NGY_BB = np.array([BESS_NGY09, BESS_NGY10, BESS_NGY11, BESS_NGY12, BESS_NGY13, BESS_NGY14, BESS_NGY15, BESS_NGY16])
######################################################################
...
#for pcount in range(NumXTALPartitions_x):
#    for gcount in range(NTopEdg_in_1_XTL_parti_X):
#        if gcount
