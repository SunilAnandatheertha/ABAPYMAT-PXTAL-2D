...
######################################################################
Modelinfo02 = (('NumXTALPartitions_x', '4'),
...
Modelinfo04 = (('XTAL_ElementFactor #ignore', '1'),
               ...
               ('ElementShapeFlagID: [1:Quad.Str],[2:Quad.Free],[3:Tri.Str],[4:Tri.Free],[5:Quad.Dom]', '5'),
...
######################################################################
# Load up default values for location B
Modelinfo08B = (('N_Grains_Y_loc_1 @B1T.. all > 0', '2'),
                ('N_Grains_Y_loc_2 @B2T', '2'),
                ('N_Grains_Y_loc_3 @B3T', '2'),
                ('N_Grains_Y_loc_4 @B4T', '2'),
                ('N_Grains_Y_loc_5 @B5T', '2'),
                ('N_Grains_Y_loc_6 @B6T', '2'),
                ('N_Grains_Y_loc_7 @B7T', '2'),
                ('N_Grains_Y_loc_8 @B8T', '3'),
                ('dummy', ':::'),
                ('N_Grains_Y_loc_8 @B8B', '3'),
                ('N_Grains_Y_loc_7 @B7B', '2'),
                ('N_Grains_Y_loc_6 @B6B', '2'),
                ('N_Grains_Y_loc_5 @B5B', '2'),
                ('N_Grains_Y_loc_4 @B4B', '2'),
                ('N_Grains_Y_loc_3 @B3B', '2'),
                ('N_Grains_Y_loc_2 @B2B', '2'),
                ('N_Grains_Y_loc_1 @B1B', '2'),
 	     	   )
if Sample_Location[0] in ['B', 'b', 'LocB', 'Loc_B', 'locb', 'loc_b']:
...
######################################################################
# HORIZONTAL EDGES
Modelinfo09B = (('TopEdge.SeedSize.AllGrains_in_Loc: @B1T. all > 0', '0.03'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B2T', '0.03'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B3T', '0.04'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B4T', '0.08'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B5T', '0.16'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B6T', '0.36'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B7T', '0.75'),
                ('TopEdge.SeedSize.AllGrains_in_Loc: @B8T', '0.80'),
                ('dummy', ':::'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B8T', '1.60'),
                ('dummy', ':::'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B8B', '0.80'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B7B', '0.75'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B6B', '0.36'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B5B', '0.16'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B4B', '0.08'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B3B', '0.04'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B2B', '0.03'),
                ('BotEdge.SeedSize.AllGrains_in_Loc: @B1B', '0.03'),
 	     	   )
if Sample_Location[0] in ['B', 'b', 'LocB', 'Loc_B', 'locb', 'loc_b']:
...
Modelinfo09BV = (('VertEdge.SeedSize.AllGrains_in_Loc: @B1T. all > 0', '2'),
                 ...
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B4T', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B5T', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B6T', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B7T', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B8T', '3'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B8B', '3'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B7B', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B6B', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B5B', '2'),
                 ('VertEdge.SeedSize.AllGrains_in_Loc: @B4B', '2'),
...
# XTAL_AllSetNames
# AllSubDomain_centre_X
# AllSubDomain_centre_Y
...
for xpos in range(NumXTALPartitions_x):
    ...
    for ypos in range(NumXTALSubDomains):
        ...
        Total_HardeningMatModel_Subdomains
...
Hor_Edge_Seeding_Constraint, dummy1, dummy2,dummy3,\
 =  getInputs(fields = Modelinfo10, label = 'SEED:to:ELEM conformity@HOR.EDGES', dialogTitle = 'Modelinfo10A: FE seed behaviour', )
...
######################################################################
#1:Quad.Str],[2:Quad.Free],[3:Tri.Str],[4:Tri.Free],[5:Quad.Dom]
######################################################################
