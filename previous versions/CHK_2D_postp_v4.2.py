...
fields = (('S11_contour_label_max_MPa:', '+1000'), ('S11_contour_label_min_MPa:', '+0000'),
	      ('S22_contour_label_max_MPa:', '+0100'), ('S22_contour_label_min_MPa:', '-0100'),
		  ('S12_contour_label_max_MPa:', '+0050'), ('S12_contour_label_min_MPa:', '-0050'),
		  )
...
Res_Data_Root_Filename_12 = str(NumPartitions_x*NumPartitions_y) + 'Ng_' + str(NumPartitions_x) + 'x_'+ str(NumPartitions_y) + 'y_'+ 'TEXID' + TEXIDVALUE + '_' + 'EBG' + EPGValue + '_' + ElementType + '____IMG_Stress_YY_CONTOUR____' + '_id1_' + RandomNumber_START_MATLAB_OUTPUT + '_id2_' + RandomNumber_END_MATLAB_OUTPUT + '__RESFrameNum___'

# Res_Data_Root_Filename_13: Stress 12 - contour plot image file
Res_Data_Root_Filename_13 = str(NumPartitions_x*NumPartitions_y) + 'Ng_' + str(NumPartitions_x) + 'x_'+ str(NumPartitions_y) + 'y_'+ 'TEXID' + TEXIDVALUE + '_' + 'EBG' + EPGValue + '_' + ElementType + '____IMG_Stress_XY_CONTOUR____' + '_id1_' + RandomNumber_START_MATLAB_OUTPUT + '_id2_' + RandomNumber_END_MATLAB_OUTPUT + '__RESFrameNum___'
